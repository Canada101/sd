...
class Narrative{
    ...
    CharacterSuper* chooseCharacter(){
        ...
        if(choice==1){
            ...
            cout << "You chose the Guardian." << endl;
        }
        else if(choice==2){
            characterType = new Ranger();
            cout << "You chose the Ranger." << endl;
        }
        else if(choice==3){
            characterType = new Swordsman();
            cout << "You chose the Swordsman." << endl;
        }
        else if(choice==4){
    ...
    void moveThroughStory() {
        ...
        while(1){
            if (placeInStory == 0){
                ...
                cin >> choice;
                combatNarrative.fightLakeMonster();
                placeInStory ++;
                ...
                cin >> choice;
                placeInStory ++;
            }else if(placeInStory == 11){
                cout << "You successfully defeat the king and take his power for yourself." << endl;
                break;
            }
        }   
    }
